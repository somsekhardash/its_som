...
import { EducationSchema } from "src/components/schemas/EducationSchema";
...
const EducationForm: React.FC<any> = ({ data }) => {
  ...
  // const [
  //   localeducationDefinition,
  //   setLocaleducationDefinition,
  // ] = React.useState(educationDefinition);
  ...
  useEffect(() => {
    ...
    //     var temp1 = {
    //       ...temp,
    //       items: [...updateItem(temp.items, geteducationData[node])],
    //     };
    //     var obj = { ...temp1 };
    //     obj.name = node;
    //     return obj;
    //   });
    //   localeducationDefinition.items = [
    //     ...localeducationDefinition.items,
    //     ...temppp,
    //   ];
    ...
    <div className={parentClass}>
      {showModal && (
        <div>
          <Input
            ...
            value={widgetName}
            onChange={(a, b) => setWidgetName(b.value)}
          />
      ...
      <Segment placeholder>
        <Grid columns={2} relaxed="very" stackable>
          ...
          <Grid.Column>
            {geteducationData && <FormBuilder schema={EducationSchema} />}
          </Grid.Column>
          <Grid.Column>
            <pre>
              {JSON.stringify(
                merge(geteducationData, educationComponentData),
                null,
                4
              )}
            </pre>
